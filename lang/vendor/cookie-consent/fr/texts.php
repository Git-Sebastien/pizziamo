...
return [
    ...
    'settings_text' => 'Notre site web stocke quatre types de cookies. À tout moment, vous pouvez choisir celles que vous acceptez et celles que vous refusez. Les cookies pour le bon fonctionnement du site vous permettent de pouvoir naviguer de façon optimale et de vous procurez une meilleur expérience.'
];
