<section class="presentation">
    <div>    
        <span>Benvenuto a Pizziamo da Gabriele ! </span>
        <h1> Pizza sur place ou à emporter à La Ravoire</h1>
        <span> Appelez nous : 07.69.74.77.96</span>
    </div>
    <article>
    <h3 class="text-center title">Le spécialiste des pizza italiennes traditionnelles sur Chambéry</h3>
        <p>
