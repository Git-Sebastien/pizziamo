...
<footer id="contact">
    <div class="credit-accept">
        <ul class="paiements">
            ...
            <li><img src="{{ asset('images/logo-cb.webp') }}" width=""  height="" alt="Logo paiements CB" class="logo-cb"></li>
            <li><img src="{{ asset('images/logo-cash.webp') }}" width=""  height="" alt="Logo paiements espéces" class="logo-cash"></li>
        </ul>
    </div>
