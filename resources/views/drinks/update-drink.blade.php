    ...
    <x-layout>
        <article class="col-sm-8 pizzas">
            ...
            <form action="{{ route('drink.update',$drink->id) }}" method="post" class="form-dashboard">
                ...
                <input type="text" name="drink_name" id="drink_name" value="{{ $drink->drink_name }}">
                <label for="volume">Volume</label>
                <select name="drink_volume" id="volume">
                ...
                <input type="text" name="drink_price" id="drink_price" value="{{ $drink->drink_price }}"> €
